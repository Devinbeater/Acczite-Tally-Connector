...
========//=Session-scoped=DbContext==€”=set=once=per=SyncAllMastersAsync=call.
...
========//==”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€
========//=MAIN=ENTRY=POINT==€”=strict=order:=Groups==†’=Ledgers==†’=VoucherTypes==†’=Stock
========//==”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€=”€
...
============//==”€=”€=”€=Phase=1:=Accounting=Groups=(MUST=be=first==€”=everything=depends=on=group=hierarchy)==”€=”€=”€
============await=SyncAccountingGroupsAsync(organizationId,=dbContext);
============await=PopulateDimGroupsAsync(organizationId);
============_syncMonitor.AddLog($"=œ…=Accounting=Groups=synced=and=DimGroups=populated.",="SUCCESS",="MASTERS");

============//==”€=”€=”€=Phase=2:=Ledgers=(depends=on=Groups=for=parent=resolution)==”€=”€=”€
...
============_syncMonitor.AddLog($"=œ…=Ledgers=synced=and=DimLedgers=populated.",="SUCCESS",="MASTERS");
...
============//==”€=”€=”€=Phase=5:=Stock=Groups=+=Stock=Categories=+=Stock=Items==”€=”€=”€
...
============//==”€=”€=”€=Phase=6:=Auto-map=Ledgers=to=Analytics=Categories==”€=”€=”€
...
============_syncMonitor.AddLog("=œ…=Master=Data=Sync=Complete==€”=all=phases=passed.",="SUCCESS",="MASTERS");
========}
...
================{
====================_syncMonitor.AddLog("=š =Tally=returned=empty=XML=for=groups.=Aborting=Phase=1.",="WARNING",="MASTERS");
...
================if=(nodes.Count====0)
================{
====================_syncMonitor.AddLog("=Œ=Critical:=Tally=returned=0=Accounting=Groups.=Check=Company.",="ERROR",="MASTERS");
...
================{
===================_syncMonitor.AddLog("=Œ=Critical=Fail:=Tally=returned=0=valid=Accounting=Groups=name=data.=Aborting.",="ERROR",="MASTERS");
...
================_syncMonitor.AddLog($"=Œ=Accounting=Groups=sync=failed:={ex.Message}",="ERROR",="MASTERS");
================throw;
============}
========}
...
============try
============{
================//=XML=is=now=the=primary=method==€”=more=reliable=across=Tally=versions
...
================_syncMonitor.AddLog($"=š =XML=sync=issue=({ex.Message}).=Trying=ODBC=fallback=for=Ledgers.",="WARNING",="MASTERS");
================try
================{
...
====================_syncMonitor.AddLog("=Œ=Critical:=Could=not=sync=Ledgers=via=any=channel.",="ERROR",="MASTERS");
====================throw;
================}
=
...
================if=(checkCount====0)
================{
====================_syncMonitor.AddLog("=Œ=Critical=Fail:=Both=XML=and=ODBC=returned=0=Ledgers.=Aborting=sync.",="ERROR",="MASTERS");
...
========///=<summary>
========///=Full=XML-based=ledger=sync==€”=used=when=ODBC=is=unavailable
========///=</summary>
...
================{
====================_syncMonitor.AddLog("=Œ=Tally=failed=to=return=Ledgers=after=3=attempts.",="ERROR",="MASTERS");
...
================if=(nodes.Count====0)
================{
====================_syncMonitor.AddLog("=š =Warning:=Tally=returned=0=Ledgers.=Verify=data=exists=in=Tally.",="WARNING",="MASTERS");
...
========================{
=============================_syncMonitor.AddLog($"=Œ=CRITICAL:=Ledger='{ledger.Name}'=points=to=missing=Group='{ledger.ParentGroup}'.",="ERROR",="MASTERS");
...
========================{
============================_syncMonitor.AddLog($"=Œ=AUDIT=FAIL:=Ledger='{name}'=balance=mismatch=(Local:={existing.OpeningBalance:N2}=vs=Tally:={ledger.OpeningBalance:N2})",="ERROR",="INTEGRITY");
...
========================{
===========================_syncMonitor.AddLog($"=š¡=Speed:={_syncMonitor.VouchersPerSecond:N0}=l/s=|=Progress:={count}/{nodes.Count}=Ledgers",="INFO",="MASTERS");
========================}
====================}
...
==================={
=======================_syncMonitor.AddLog($"=Œ=CRITICAL:=Balance=Mismatch!=Tally:={tallyTotal:N2}=vs=DB:={dbTotal:N2}",="ERROR",="INTEGRITY");
...
===================}
===================else={
=======================_syncMonitor.AddLog($"=œ…=Cross-System=Validation=Passed:=DB=matches=Tally=Summary=({dbTotal:N2}).",="SUCCESS",="INTEGRITY");
===================}
...
================_syncMonitor.AddLog($"=Œ=XML=Ledger=sync=also=failed:={ex.Message}",="ERROR",="MASTERS");
================throw;
============}
============finally
============{
...
====================
====================//=Only=update=GST/billing=fields==€”=balances=already=set=by=ODBC
...
============catch=(Exception=ex)
============{
================_logger.LogWarning(ex,="Failed=to=enrich=ledgers=from=XML==€”=non-critical,=continuing.");
================_syncMonitor.AddLog($"=š =Ledger=enrichment=failed=(non-critical):={ex.Message}",="WARNING",="MASTERS");
============}
========}
...
============//=Tally=encodes=balances=as=positive/negative=text==€”=parse=carefully
...
================_syncMonitor.AddLog($"=š =ODBC=StockItems=failed.=Falling=back=to=XML.",="WARNING",="MASTERS");
...
========//============================================================private=async=Task=PopulateDimLedgersAsync(Guid=orgId,=AppDbContext=dbContext)
========{
...
============{
================//=Resolve=GroupId=from=DimGroups==€”=THIS=WAS=THE=CRITICAL=BUG=(was=always=Guid.Empty)
...
========//=============================================================================================================================
========//=INTEGRITY=VALIDATION==€”=catch=data=quality=issues
========//=============================================================================================================================
========private=async=Task=ValidateIntegrityAsync(Guid=orgId,=AppDbContext=dbContext)
========{
============int=issues===0;

============//=1.=Orphan=Ledgers==€”=Parent=group=doesn't=exist
...
================{
====================_syncMonitor.AddLog($"=š =Orphan=Ledger:='{l.Name}'==†’=parent=group='{l.ParentGroup}'=not=found.",="WARNING",="INTEGRITY");
====================issues++;
================}
============}
...
================{
====================_syncMonitor.AddLog($"=š =Orphan=Group:='{g.Name}'==†’=parent='{g.Parent}'=not=found.",="WARNING",="INTEGRITY");
====================issues++;
================}
============}
...
============{
================_syncMonitor.AddLog($"=š =Duplicate=Ledger:='{d.Name}'=appears={d.Count}=times.",="WARNING",="INTEGRITY");
================issues++;
============}
...
============if=(emptyGroupDims=>=0)
============{
================_syncMonitor.AddLog($"=š ={emptyGroupDims}=DimLedgers=have=unresolved=GroupId=(Guid.Empty).",="WARNING",="INTEGRITY");
================issues++;
============}

============//=Summary
============if=(issues====0)
================_syncMonitor.AddLog("=œ…=Integrity=check=passed==€”=no=issues=found.",="SUCCESS",="INTEGRITY");
============else
================_syncMonitor.AddLog($"=š =Integrity=check=found={issues}=issue(s).=Review=warnings=above.",="WARNING",="INTEGRITY");
========}
...
================_syncMonitor.AddLog($"=Œ={reportName}=sync=failed:={ex.Message}",="ERROR",="MASTERS");
============}
========}
====}
}
